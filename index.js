...
const PATTERNS = [
  ...
  { id: "tls-old",      name: "TLS 1.0 / 1.1",    sev: "critical", re: /TLSv1(?:\.0|\.1)?\b|PROTOCOL_TLSv1(?:_1)?\b|ssl\.TLSv1\b/i },
  { id: "md5",          name: "MD5",               sev: "critical", re: /\bMD5\b|md5\(|hashlib\.md5|MessageDigest\.getInstance\s*\(\s*["']MD5["']\)|new\s+MD5\(\)/i,  alt: "SHA3-256 or SHA-256" },
  { id: "sha1",         name: "SHA-1",             sev: "critical", re: /\bSHA1\b|\bsha1\s*\(|hashlib\.sha1\b|MessageDigest\.getInstance\s*\(\s*["']SHA-?1["']\)/i,    alt: "SHA-256" },
  { id: "des",          name: "DES",               sev: "critical", re: /\bDES\b(?!C?SHA|\s*ede)|DESKeySpec|DES\.new\b|Cipher\.getInstance\s*\(\s*["']DES[/"']/i },
  ...
  { id: "ecb",          name: "AES-ECB (no IV)",   sev: "critical", re: /\/ECB\/|AES\.MODE_ECB|Cipher\.getInstance\s*\(\s*["']AES["']|["']AES\/ECB/i,                  alt: "AES-GCM or ChaCha20-Poly1305" },
  ...
  { id: "rsa",          name: "RSA",               sev: "high",     re: /RSA(?:Key(?:Pair)?|PublicKey|PrivateKey|Generator|Encryptor|Decryptor|Signature)?(?:\s*\(|\s*\.\s*(?:generate|new|create|load|import))\b|generateRSA|Rsa(?:Private|Public|Key)|PKCS1_(?:v1_5|OAEP)|import_rsa_key|openssl_pkey_new/i, alt: "ML-KEM (CRYSTALS-Kyber)" },
  ...
  { id: "ecdsa",        name: "ECDSA",             sev: "high",     re: /\bECDSA\b|ECDSASignature|ecdsa_(?:sign|verify)|ES(?:256|384|512)\b/i,                          alt: "ML-DSA (CRYSTALS-Dilithium)" },
  ...
  { id: "dsa",          name: "DSA",               sev: "high",     re: /\bDSA\b(?!SHA|_KEY_SIZE|Version)|DSAKeySpec|DSAPublicKey|DSAPrivateKey|DSASignature/i,         alt: "ML-DSA (CRYSTALS-Dilithium)" },
  ...
  { id: "ecc",          name: "ECC generic",       sev: "high",     re: /EllipticCurve|ECGenParameterSpec|ECPublicKey|ECPrivateKey|EcKey\b|ec\.generate_private_key/i },
