...
const PATTERNS = [
  ...
  { id: "ruby-openssl-pkey", name: "Ruby OpenSSL PKey RSA/EC/DSA",   sev: "high", re: /OpenSSL::PKey::(?:RSA|EC|DSA)\.(?:new|generate)|OpenSSL::SSL::SSLContext\.new|require\s+['"\]openssl['"]\n.*PKey/i, alt: "openssl-oqs gem (ML-KEM / ML-DSA) or Ruby oqs-provider" }, // quantumscan-ignore
  ...
  { id: "nodejs-crypto-asym", name: "Node.js crypto asymmetric ops",  sev: "high", re: /crypto\.createECDH\s*\(|generateKeyPairSync\s*\(\s*['"\](?:rsa|ec|dsa|ed25519|x25519)['"]|crypto\.createSign\s*\(|createDiffieHellman\s*\(|DiffieHellman\.generateKeys/i, alt: "Node.js crypto.generateKeyPairSync with ML-KEM-768 via oqs-node binding" }, // quantumscan-ignore
  ...
  { id: "dart-pointycastle",  name: "Dart pointycastle RSA/EC",        sev: "high", re: /(?:package:pointycastle|RSAKeyGenerationParameters|ECKeyGeneratorParameters|RSAPrivateKey\s*\(|ECPrivateKey\s*\(|AsymmetricKeyPair<RSA|AsymmetricKeyPair<EC)/i, alt: "package:cryptography with ML-KEM-768 (liboqs FFI) when Dart binding lands" }, // quantumscan-ignore
